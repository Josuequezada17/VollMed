DELETE FROM `vollmed1_api`.`medicos`;


INSERT INTO `vollmed1_api`.`medicos` (`id`, `nombre`, `email`, `documento`, `especialidad`, `calle`, `distrito`, `complemento`, `numero`, `ciudad`, `telefono`, `activo`)
