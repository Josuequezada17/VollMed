DELETE
FROM `vollmed_api`.`medicos`;


INSERT INTO `vollmed_api`.`medicos` (`id`, `nombre`, `email`, `documento`, `especialidad`, `calle`, `distrito`,
                                     `complemento`, `numero`, `ciudad`, `telefono`, `activo`)
